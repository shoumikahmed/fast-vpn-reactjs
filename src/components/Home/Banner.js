...
const Banner = () => {
    return (
        <section className='flex justify-around items-center'>
            ...
            <div>
                <h1 className='text-5xl font-bold text-white'>Fast, Secure,</h1>
                <h1 className='text-5xl font-bold text-white'>Smart VPN</h1>
                <p className='mt-10 text-[#CCD9F1]'>Maximum security, minimul cost.FastVPN is a top</p>
